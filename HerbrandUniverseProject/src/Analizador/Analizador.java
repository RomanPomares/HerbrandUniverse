...
public class Analizador implements AnalizadorConstants {
  ...
  final public void Input() throws ParseException {
    ...
    while (true) {
      ...
      case CONSTANTE:
        ...
        break;
      case LETRAPREDICADO:
        jj_consume_token(LETRAPREDICADO);
        break;
      case LETRAVARIABLE:
        jj_consume_token(LETRAVARIABLE);
        break;
      case LETRAFUNCION:
        jj_consume_token(LETRAFUNCION);
        break;
      default:
        jj_la1[1] = jj_gen;
        jj_consume_token(-1);
  ...
  final public void predicados() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NEGACION:
      jj_consume_token(NEGACION);
      jj_consume_token(LETRAPREDICADO);
  ...
  final public void inPredicados() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LETRAFUNCION:
      funcion();
      break;
  ...
  final public void inFuncion() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LETRAFUNCION:
      funcion();
      break;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xff6,0xff6,0x48,0xb80,0x48,0x280,0xd00,0x60,0xd00,0x60,};
   }
